...
export const inputClasses =
  ...
  "focus:border-violet-400 focus:bg-field-focus focus:ring-4 focus:ring-violet-400/15";
...
export const iconButtonClasses =
  ...
  "transition-colors hover:bg-rose-400/15 hover:text-danger-text focus-visible:ring-2 focus-visible:ring-violet-400 " +
